...
//File to test: /home/kevus/git2019/astutmatcher/Examples/ASTUTCave.cpp
//DESCRIPTION: This file sets tests cases for ASTUTCave.
//DATE: 30-01-2019 11:52:57
////////////////////////////////////////////////////////////////////////////////

#include "/home/kevus/git2019/astutmatcher/Examples/ASTUTCave.cpp"
...
struct Fixture {
	...
	customType Read_struct_customType(string objectKey)
	{
		...
		customType result;
		result.number = boost::lexical_cast<int>(values[0]);
		result.name = values[1];
		result.kevin = boost::lexical_cast<double>(values[2]);
		result.valle = boost::lexical_cast<float>(values[3]);
...
ostream& operator<<(ostream& stream, customType& a)
{
	stream << a.number << endl;
	stream << a.name << endl;
	stream << a.kevin << endl;
	stream << a.valle << endl;
