...
struct Fixture : public ::testing::Test {
    ...
    void Date(std::string value) {
        ...
        std::cout << value << ": " << tmt->tm_year + 1900 << "-";
        std::cout << std::setw(2) << std::setfill('0') << tmt->tm_mon + 1
                  << "-";
        std::cout << std::setw(2) << std::setfill('0') << tmt->tm_mday << "T";
        std::cout << std::setw(2) << std::setfill('0') << tmt->tm_hour << ":";
        std::cout << std::setw(2) << std::setfill('0') << tmt->tm_min << ":";
        std::cout << std::setw(2) << std::setfill('0') << tmt->tm_sec
                  << "+02:00";
    }
//{readObject}
{newMethods}
...
private:
	...
	static inline map<string, map<string, string>> configContent = {};
};
//{overloadOperator}
