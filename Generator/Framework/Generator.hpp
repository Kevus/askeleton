...
public:
    ...
    virtual void generateMethodAssert(const std::string &method,
                                      ...
                                      const InfoType &returnType) = 0;
    virtual void
    generateConstructorAssert(const std::string &constructor,
                              const std::vector<InfoVariable> &parameters) = 0;
...
private:
    ...
    static std::string getTemplatePath(const std::string &methodTemplate = "");
