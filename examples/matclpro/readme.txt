...
Note for ASkeleTon:
- The file "include/matrix.cc" is a template implementation unit that is meant
  to be included by headers, not compiled as a standalone translation unit.
- For test generation, use "test/testmat.cpp" as the compilation unit.
